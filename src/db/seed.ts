...
export const realProducts = [
  ...
  {
    title: "Fluffy Brown Teddy Bow Keychain",
    description: "Super soft handcrafted brown teddy bear silhouette keychain adorned with a cute pink bow and pearl accent with gold keyring.",
    price: 500,
    imageUrl: "/products/fluffy-teddy-keychain.jpg",
    category: "Key Chains",
  },
  {
    title: "Cute Lion Face Charm Keychain",
    description: "Handcrafted friendly lion face charm with vibrant orange fur, large rounded ears, and fluffy brown swirling mane with gold keyring.",
    price: 500,
    imageUrl: "/products/lion-face-keychain.jpg",
    category: "Key Chains",
  },
  {
    title: "Lion Mane Mirror Keychain",
    description: "Handy compact pocket mirror framed by swirling chocolate-brown and golden-orange pipe cleaner lion mane with attached gold keyring.",
    price: 500,
    imageUrl: "/products/lion-mirror-keychain.jpg",
    category: "Key Chains",
  },
  {
    title: "Sunflower Petal Mirror Keychain",
    description: "Bright handcrafted sunflower pocket mirror with golden yellow petals and braided brown center frame on a sturdy gold keyring.",
    price: 500,
